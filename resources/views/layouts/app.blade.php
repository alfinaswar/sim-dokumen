            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="airplay"></i><span>Situasi Maritim</span></a>
                  </li>
                  <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="layout"></i><span>Perkiraan Cuaca</span></a>
                  </li>
                    <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="layout"></i><span>Pantauan Kapal</span></a>
                  </li>
                   <li class="sidebar-main-title">
                    <div>
                      <h6>Data Master</h6>
                  ...
                  <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="home"></i><span>Master Akun</span></a>
                  <li class="dropdown"><a class="nav-link menu-title" href="{{route('kategori.index')}}"><i data-feather="home"></i><span>Master Kategori</span></a>
                </li>
                </ul>
              </div>
