                                        ...
                                        <tbody>
                                            @foreach ($kat->getSituasiMaritim as $no => $detail)
                                                <tr>
                                                    ...
                                                    <td>{{ $detail->Lokasi }}</td>
                                                    <td>{{ $detail->Waktu }}</td>
                                                    <td>  <a class="btn btn-warning btn-edit" href="{{route('situasi-maritim.edit', $detail->id)}}">Edit</a>
                  <a class="btn btn-danger btn-delete" data-id="{{  $detail->id }}">Hapus</a></td>
                                                </tr>
                                            @endforeach
            ...
            <div class="modal-body">
                <form id="updateForm" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="update-lokasi" name="Lokasi" placeholder="Lokasi" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="update-keterangan" name="Keterangan" placeholder="Keterangan" rows="3" required></textarea>
                    </div>
    ...
    $('body').on('click', '.btn-delete', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route('situasi-maritim.destroy', ':id') }}'.replace(':id', id),
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
